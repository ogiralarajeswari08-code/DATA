...
const Books = ({ wishlistItems, onAddToCart, onToggleWishlist, onViewProduct, cartItems, navigateTo, searchQuery }) => {
    ...
    const fetchProducts = async () => {
        try {
            ...
            if (response.ok) {
                ...
                console.error('Failed to fetch books products');
