...
const BeautyProductCard = ({ product, onAddToCart, onToggleWishlist, isWishlisted, onViewProduct, cartItems, navigateTo }) => {
            ...
            <div className="product-info">
                ...
                <div className="product-actions">
                    <button
                        ...
                        <i className={isWishlisted ? "fas fa-heart" : "far fa-heart"} style={{ color: isWishlisted ? 'var(--secondary)' : 'var(--gray)' }} />
                    </button>
